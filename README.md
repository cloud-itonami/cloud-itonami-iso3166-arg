# cloud-itonami-iso3166-arg

Open ISO 3166 Blueprint for **ARG**: Argentina.
...
tax registration, and local-content rules in Argentina, so the operator
...
- **Not the government of Argentina.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Argentine-licensed counsel
...
(ISO 3166 `ARG`). Required capabilities:
